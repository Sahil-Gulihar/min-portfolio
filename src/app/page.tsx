        ...
        <div className="w-full space-y-8">
          <BlurFade delay={BLUR_FADE_DELAY * 11}>
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              ...
              I&apos;ve built everything from AI pipelines to web apps and developer tools. Here are a few favorites.
                </p>
              </div>
            </div>
          </BlurFade>
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 max-w-[800px] mx-auto">
            {DATA.latestProjects.map((project, id) => (
              <BlurFade
                key={project.title}
      ...
      <section id="hackathons">
        <div className="space-y-12 w-full py-12">
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 14}>
            <ul className="mb-4 ml-4 divide-y overflow-visible divide-dashed border-l">
